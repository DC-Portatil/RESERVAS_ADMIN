<table class="table">
	...
	<tr>	
		<td>&nbsp;</td>
		<td align="center">
			<div class="alert alert-info">Futbito. Pista Polideportiva</div>
		</td>
	</tr>
	<tr>
<?php 
...
include "includes/indica_inicio_iluminacion_futbito.php";
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<div class="row">
	      	<div class="col-md-7">
	      		...
	      		<input type="hidden" value="futbito" name="tipo_pista">
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-danger" onclick="document.form1.submit();">Conirmar Reserva</button>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
...
<script type="text/javascript">
	$(document).on("click", ".openDialog", function () {
		 ...
		 if (pista=="Futbol 5") { $("#doreserva #titpista, #pista").html("Futbol 5 (Dura)");}
		 if (pista=="Fronton 2") { $("#doreserva #titpista, #pista").html("Fronton 2 (Dura)");}
		 if (pista=="Fronton 3") { $("#doreserva #titpista, #pista").html("Fronton 3 (Dura)");}		
		 if (pista=="Fronton 4") { $("#doreserva #titpista, #pista").html("Fronton 4 (C&eacute;sped)");	}
		 if (pista=="Fronton 5") { $("#doreserva #titpista, #pista").html("Fronton 5 (C&eacute;sped)");	}
		 if (pista=="Fronton 6") { $("#doreserva #titpista, #pista").html("Fronton 6 (C&eacute;sped)");	}	

		if (hora=="h9") { $("#doreserva #tithora").html("De 09:00 a 10:00");}
		if (hora=="h10") { $("#doreserva #tithora").html("De 10:00 a 11:00");}
		if (hora=="h11") { $("#doreserva #tithora").html("De 11:00 a 12:00");}
		if (hora=="h12") { $("#doreserva #tithora").html("De 12:00 a 13:00");}
		if (hora=="h13") { $("#doreserva #tithora").html("De 13:00 a 14:00");}
		if (hora=="h14") { $("#doreserva #tithora").html("De 14:00 a 15:00");}
		if (hora=="h15") { $("#doreserva #tithora").html("De 15:00 a 16:00");}
		if (hora=="h16") { $("#doreserva #tithora").html("De 16:00 a 17:00");}
		if (hora=="h17") { $("#doreserva #tithora").html("De 17:00 a 18:00");}
		if (hora=="h18") { $("#doreserva #tithora").html("De 18:00 a 19:00");}
		if (hora=="h19") { $("#doreserva #tithora").html("De 19:00 a 20:00");}
		if (hora=="h20") { $("#doreserva #tithora").html("De 20:00 a 21:00");}
		if (hora=="h21") { $("#doreserva #tithora").html("De 21:00 a 22:00");}
});
</script>