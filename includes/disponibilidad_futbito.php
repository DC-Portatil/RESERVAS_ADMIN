...
$h1h9 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h9<1) {$h1h9_btn_text = "Reservar"; $h1h9_btn_class = "futbito";}
...
$h1h95 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h95<1) {$h1h95_btn_text = "Reservar"; $h1h95_btn_class = "futbito";}
...
$h1h10 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h10<1) {$h1h10_btn_text = "Reservar"; $h1h10_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h105<1) {$h1h105_btn_text = "Reservar"; $h1h105_btn_class = "futbito";}
...
$h1h11 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h11<1) {$h1h11_btn_text = "Reservar"; $h1h11_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h115<1) {$h1h115_btn_text = "Reservar"; $h1h115_btn_class = "futbito";}
...
$h1h12 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h12<1) {$h1h12_btn_text = "Reservar"; $h1h12_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h125<1) {$h1h125_btn_text = "Reservar"; $h1h125_btn_class = "futbito";}
...
$h1h13 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h13<1) {$h1h13_btn_text = "Reservar"; $h1h13_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h135<1) {$h1h135_btn_text = "Reservar"; $h1h135_btn_class = "futbito";}
...
$h1h14 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h14<1) {$h1h14_btn_text = "Reservar"; $h1h14_btn_class = "futbito";}
...
$h1h14 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h145<1) {$h1h145_btn_text = "Reservar"; $h1h145_btn_class = "futbito";}
...
$h1h15 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h15<1) {$h1h15_btn_text = "Reservar"; $h1h15_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h155<1) {$h1h155_btn_text = "Reservar"; $h1h155_btn_class = "futbito";}
...
$h1h16 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h16<1) {$h1h16_btn_text = "Reservar"; $h1h16_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h165<1) {$h1h165_btn_text = "Reservar"; $h1h165_btn_class = "futbito";}
...
$h1h17 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h17<1) {$h1h17_btn_text = "Reservar"; $h1h17_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h175<1) {$h1h175_btn_text = "Reservar"; $h1h175_btn_class = "futbito";}
...
$h1h18 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h18<1) {$h1h18_btn_text = "Reservar"; $h1h18_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h185<1) {$h1h185_btn_text = "Reservar"; $h1h185_btn_class = "futbito";}
...
$h1h19 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h19<1) {$h1h19_btn_text = "Reservar"; $h1h19_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h195<1) {$h1h195_btn_text = "Reservar"; $h1h195_btn_class = "futbito";}
...
$h1h20 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h20<1) {$h1h20_btn_text = "Reservar"; $h1h20_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h205<1) {$h1h205_btn_text = "Reservar"; $h1h205_btn_class = "futbito";}
...
$h1h21 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h21<1) {$h1h21_btn_text = "Reservar"; $h1h21_btn_class = "futbito";}
...
$gb -> setClose();		
if ($h1h215<1) {$h1h215_btn_text = "Reservar"; $h1h215_btn_class = "futbito";}
...
$h1h21 = $gb -> getNumRows();
$gb -> setClose();		
if ($h1h22<1) {$h1h22_btn_text = "Reservar"; $h1h22_btn_class = "futbito";}
